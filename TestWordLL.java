...
public class TestWordLL {
	...
	public static void main(String[] args) {
		...
		int[][] intArr = {{2,5,0,1},
			...
			{1,5,0,4},
			{1,3,3,1},
			{2,0,4,0}};			// i think my test is failing because of the 4 that is put in here
		...
		System.out.println("Word: !JC! !9D! !KH! !9S! ");
		System.out.println("Word: -10C- -QC- -QD- -10H- ");
		System.out.println("Word: -10C- -AD- .9H. +KH+ ");

		test(12,"ExtendLetter WordLL tryWord +", wll2.toString().contains("Word: !JC! !9D! !KH! !9S! ") &&
		wll2.toString().contains("Word: -10C- -QC- -QD- -10H- ") &&
		wll2.toString().contains("Word: -10C- -AD- .9H. +KH+ ") &&			//here it says .9H. but mine says -9H-
